...
```bash
cd ~/RESEARCH-in-sleep-RETRON-DB_V2
...
> (established style) + REPORT.md. One script per section (≤500 lines), run each after
> writing. Locate-then-patch when reusing old code. Write STATUS.md last, then stop.

## Phase 3 — RETRO (after it stops)
Write `../RESEARCH-in-sleep-GENERAL_v2/retros/YYYY-MM-DD.md`:
...
- Anything to fold into GENERAL_v2/specs/WORKING_AGREEMENT.md or REPORTING_STANDARDS.md.
